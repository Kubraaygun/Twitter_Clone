  ...
  return (
    <div className="flex flex-col justify-between items-end px-2 py-4">
      ...
      <div>
        ...
        {navSections.map((i) => (
          <div key={i.title} className="flex justify-center md:justify-normal items-center gap-3 text-2xl md:text-xl p-3 cursor-pointer transition rounded-lg hover:bg-[#505050b7] ">
            {i.icon}
